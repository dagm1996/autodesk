...
const ResearchCard = ({
  ...
  return (
    <section>
      {/* Card  */}
      <div className=" mx-auto w-full max-w-sm pt-6 my-3">
        <Link
          to={`/research/${id}`}
          href="#"
              ...
              <div className="mt-4 grid grid-cols-2 ">
                <div className="flex items-center ">
                  <div className="relative">
                    ...
                    <p
                      className="mt-2 flex gap-2 line-clamp-1 text-sm text-gray-800 text-left"
                      title="New York, NY 10004, United States"
                    >
                      <AiOutlineUser /> <span>{author} </span>
                    </p>
                  </div>
                </div>
              </div>

              <div className="mt-2 border-t text-left border-gray-200 pt-3 pl-2 ">
                {description}
              </div>

              <div className=" ml-2 border-b border-t border-gray-200 pb-3 pt-3">
                {/* <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                  ...
                  <span className="xl:mt-0"> Published year </span>
                </p> */}
                <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                  <BsClock className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4" />
                  {/* <svg
                    className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
                    viewBox="0 0 18 18"
                    fill="none"
                  ...
                  <span className="mt-0"> {publishedYear} </span>
                </p>
              </div>
            </div>
          </div>
